...
- 🤖 **AI-Augmented Development**: Regularly leveraging modern AI-assisted engineering workflows using tools like Claude Code, Cursor, Codex, Antigravity IDE, and advanced LLMs including Claude, GPT-5.5, Gemini, and other frontier AI models to improve development speed, debugging, architecture planning, and documentation.
...
- **[💳 Web Merchant Integration System 2.0](https://github.com/Sarim375/Loyalty-Points-Management-System-2.0)**: A complete migration of a legacy merchant integration system to **.NET 8** using **Clean Architecture** and secure **Maker-Checker (Four-Eyes)** approval workflows (proprietary design showcase).
- **[💳 Loyalty Points Management System 2.0](https://github.com/Sarim375/Loyalty-Points-Management-System-2.0)**: An enterprise rewards management system built with **ASP.NET Core Razor Pages**, implementing secure bulk file validations, transactional point payouts, and cardholder encryption profiles (proprietary design showcase).
